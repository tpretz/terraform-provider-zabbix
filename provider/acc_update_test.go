...
// serverInterfaceOf turns a getter for an object carrying an "interfaceid"
// into a getter for the interface itself, so that a test can assert which
// interface the server has an item or discovery rule on by a property a human
// wrote -- the port -- rather than by an opaque id the test would have had to
// learn from the provider it is checking.
func serverInterfaceOf(get serverGetter) serverGetter {
	return func(api *zabbix.API, id string) (map[string]interface{}, error) {
		obj, err := get(api, id)
		if err != nil {
			return nil, err
		}
		raw, ok := serverValue(obj, "interfaceid")
		if !ok {
			return nil, fmt.Errorf("the server returned no interfaceid for id %s", id)
		}
		var ifaces []map[string]interface{}
		err = api.CallWithErrorParse("hostinterface.get", zabbix.Params{
			"output":       "extend",
			"interfaceids": []string{serverString(raw)},
		}, &ifaces)
		if err != nil {
			return nil, err
		}
		if len(ifaces) != 1 {
			return nil, fmt.Errorf("hostinterface.get returned %d interfaces for %s, want 1", len(ifaces), serverString(raw))
		}
		return ifaces[0], nil
	}
}
...
var updateOwner = map[string]string{
	"zabbix_graph.do3d":                                   "TestAccUpdateGraph",
	"zabbix_graph.height":                                 "TestAccUpdateGraph",
	"zabbix_graph.item":                                   "TestAccUpdateGraph",
	"zabbix_graph.item.color":                             "TestAccUpdateGraph",
	"zabbix_graph.item.drawtype":                          "TestAccUpdateGraph",
	"zabbix_graph.item.function":                          "TestAccUpdateGraph",
	"zabbix_graph.item.itemid":                            "TestAccUpdateGraph",
	"zabbix_graph.item.sortorder":                         "TestAccUpdateGraph",
	"zabbix_graph.item.type":                              "TestAccUpdateGraph",
	"zabbix_graph.item.yaxis_side":                        "TestAccUpdateGraph",
	"zabbix_graph.legend":                                 "TestAccUpdateGraph",
	"zabbix_graph.name":                                   "TestAccUpdateGraph",
	"zabbix_graph.percent_left":                           "TestAccUpdateGraph",
	"zabbix_graph.percent_right":                          "TestAccUpdateGraph",
	"zabbix_graph.type":                                   "TestAccUpdateGraph",
	"zabbix_graph.width":                                  "TestAccUpdateGraph",
	"zabbix_graph.work_period":                            "TestAccUpdateGraph",
	"zabbix_graph.ymax":                                   "TestAccUpdateGraph",
	"zabbix_graph.ymax_itemid":                            "TestAccUpdateGraph",
	"zabbix_graph.ymax_type":                              "TestAccUpdateGraph",
	"zabbix_graph.ymin":                                   "TestAccUpdateGraph",
	"zabbix_graph.ymin_itemid":                            "TestAccUpdateGraph",
	"zabbix_graph.ymin_type":                              "TestAccUpdateGraph",
	"zabbix_proto_trigger.comments":                       "TestAccUpdateTrigger",
	"zabbix_proto_trigger.correlation_mode":               "TestAccUpdateTrigger",
	"zabbix_proto_trigger.correlation_tag":                "TestAccUpdateTrigger",
	"zabbix_proto_trigger.dependencies":                   "TestAccUpdateTrigger",
	"zabbix_proto_trigger.enabled":                        "TestAccUpdateTrigger",
	"zabbix_proto_trigger.event_name":                     "TestAccUpdateTrigger",
	"zabbix_proto_trigger.expression":                     "TestAccUpdateTrigger",
	"zabbix_proto_trigger.manual_close":                   "TestAccUpdateTrigger",
	"zabbix_proto_trigger.multiple":                       "TestAccUpdateTrigger",
	"zabbix_proto_trigger.name":                           "TestAccUpdateTrigger",
	"zabbix_proto_trigger.opdata":                         "TestAccUpdateTrigger",
	"zabbix_proto_trigger.priority":                       "TestAccUpdateTrigger",
	"zabbix_proto_trigger.recovery_expression":            "TestAccUpdateTrigger",
	"zabbix_proto_trigger.recovery_none":                  "TestAccUpdateTrigger",
	"zabbix_proto_trigger.tag":                            "TestAccUpdateTrigger",
	"zabbix_proto_trigger.url":                            "TestAccUpdateTrigger",
	"zabbix_lld_agent.condition":                          "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.condition.id":                       "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.condition.macro":                    "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.condition.operator":                 "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.condition.value":                    "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.delay":                              "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.description":                        "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.evaltype":                           "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.formula":                            "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.interfaceid":                        "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.key":                                "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.lifetime":                           "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.macro":                              "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.macro.macro":                        "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.macro.path":                         "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.name":                               "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.preprocessor":                       "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.preprocessor.error_handler":         "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.preprocessor.error_handler_params":  "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.preprocessor.params":                "TestAccUpdateLLDAgent",
	"zabbix_lld_agent.preprocessor.type":                  "TestAccUpdateLLDAgent",
	"zabbix_item_agent.active":                            "TestAccUpdateItemAgent",
	"zabbix_item_agent.delay":                             "TestAccUpdateItemAgent",
	"zabbix_item_agent.description":                       "TestAccUpdateItemAgent",
	...
	"zabbix_item_agent.units":                             "TestAccUpdateItemAgent",
